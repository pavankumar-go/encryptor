...
//+kubebuilder:rbac:groups=encryptor.k8s.io,resources=pushencryptedsecrets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=encryptor.k8s.io,resources=pushencryptedsecrets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=encryptor.k8s.io,resources=pushencryptedsecrets/finalizers,verbs=update
